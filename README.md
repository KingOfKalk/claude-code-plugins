...
- [**obsidian**](plugins/obsidian/skills/obsidian/SKILL.md) — *skill* — PARA-aware Obsidian vault operations via the Obsidian CLI, with safety rules for known silent-failure modes. Bundles a [**daily**](plugins/obsidian/skills/daily/SKILL.md) skill for morning planning and evening review of the daily journal.
